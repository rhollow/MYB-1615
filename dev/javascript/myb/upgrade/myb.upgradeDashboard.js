...
require(["jquery","sakai/sakai.api.core", "myb/myb.api.core"], function($, sakai, myb) {
     ...
     */
    sakai_global.upgradeDashboard = function() {
                    ...
                    success: function(data) {
                        ...
                        $.each(data.results, function(index, row) {
                            if ( row.body.length > 0 ) {
                                ...
                                var dashboard = sakai.api.Server.convertObjectToArray(rawObj, null, null);
        ...
        var processDashboard = function(dashboard, url) {
            sakai.api.Server.removeJCRObjects(dashboard);
    ...
    sakai.api.Widgets.Container.registerForLoad("upgradeDashboard");
});
