...
sakai.inbox = function(){
    ...
    var inboxComposeMessage = inboxCompose + "_message"; // new message
    var inboxComposeNotification = inboxCompose + "_notification"; // new notification
     ...
     *
     */
    // Setting up "Compose a new..." drop down menu.
    $(inboxComposeNew).click(function(){
        // show the selector (the drop down menu)
    ...
    // Event handler for Compose a new... --> Message
    $(inboxComposeMessage).click(function(){ // DROP DOWN MENU ELEMENT
        showPane(inboxPaneCompose); // OUTER DIV OF WIDGET        
    ...
    // Event handler for Compose a new... --> Notification
    $(inboxComposeNotification).click(function(){
        showPane(inboxPaneCreateNotification);      
        // !--- NEEDS WORK STILL --!  
        // initialize the sendmessage widget
        // we tell it to show it in our id and NOT as a layover
        sakai.sendmessage.initialise(null, true, inboxComposeNewContainer, sendMessageFinished);
