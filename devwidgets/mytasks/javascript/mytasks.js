...
require(["jquery", "sakai/sakai.api.core"], function($, sakai) {
    ...
    sakai_global.mytasks = function(tuid) {
        ...
        var buildExtraQueryParams = function(isArchiveMode) {
            ...
            return "&startDate=" + Globalization.format(startDate, DATE_FORMAT_ISO8601)
                    + "&endDate=" + Globalization.format(endDate, DATE_FORMAT_ISO8601)
        ...
        var checkForOverdueTasks = function() {
            ...
            var overdueTaskSearchURL = "/var/notices/tasks.json?startDate=" +
                    Globalization.format(BEGINNING_OF_TIME, DATE_FORMAT_ISO8601)
                    + "&endDate=" + Globalization.format(new Date(), DATE_FORMAT_ISO8601) +
